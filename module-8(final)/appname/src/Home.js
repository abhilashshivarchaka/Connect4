    ...
    return (
      <div>
        ...
        <p id="l"><ol>
            ...
            <li>The bottom of the vertical game board has a switch that you slide to make the pieces drop out of the board. </li>
            <li>This is a great opportunity to put the box underneath the game board to collect all of checker pieces together.</li>
            </ol></p>
      </div>
    );
  }
